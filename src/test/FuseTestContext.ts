...
export class FuseTestContext extends FuseContext {
    protected override _createFuseAPIFactory(): AbstractFuseAPIFactory {
        return new FuseTestAPIFactory();
    }

    protected override _createPlatformResolver(): PlatformResolver {
        return new FuseTestPlataformResolver();
    }
}
